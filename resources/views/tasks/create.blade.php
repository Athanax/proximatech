        ...
        <div class="col-md-10 col-md-offset-1 ">
            <div class="panel panel-default">
                <div class="panel-body">
                    <form class="col-md-offset-1" action="{{ route('tasks.store') }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group row">
                            <label for="tittle" class="col-md-4 control-label">Tittle</label>
            
                            <div class="col-md-6">
                                <input  type="tittle" class="form-control" name="tittle" value="" autofocus> 
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="duration" class="col-md-4 control-label">Due Date</label>
            
                            <div class="col-md-6">
                                <input  type="date" class="form-control" name="duration" value="" autofocus> 
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-10">
                                    <label for="duration" class="control-label">Desctiption</label><br>
                                    <textarea class="form-control" id="editor" name="description"  cols="4" rows="4">
    
                                    </textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="duration" class="col-md-4 control-label">Attachmemt</label>
            
                            <div class="col-md-6">
                                <input  type="file" class="" name="attachment" value="" autofocus> 
                            </div>
                        </div>
